    ...
    return (
        <main>
            <span className="leading-normal max-w-xs md:max-w-none">
                <p>Sempre tive interesse na área da tecnologia, mexendo com criação de servidores de jogos durante a adolescência. Cheguei a fazer alguns sobre Python e a tríade web na época do ensino médio.</p>
